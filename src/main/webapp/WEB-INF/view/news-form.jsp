    ...
    <a href="${locale_ru}"><c:out value="${button_ru}" /></a>
		...
		<tr>
			...
			<td>
                ...
                <form:option value="Minsk News" label="Minsk News" />
                <form:option value="Gomel news" label="Gomel news" />
                <form:option value="Brest news" label="Brest news" />
                <form:option value="Grodno news" label="Grodno news" />
                <form:option value="Vitebsk news" label="Vitebsk news" />
                </form:select>
